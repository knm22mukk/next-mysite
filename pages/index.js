  ...
  return (
    <Layout>
      ...
      <section className="pt-10 container mx-auto px-6 md:px-0">
        <h1 className="text-3xl font-bold text-gray-600 mb-10">texttexttexttexttexttexttexttexttext</h1>
        <div className="grid sm:grid-cols-3 gap-4 grid-cols-2">
          <div>
            <div className="bg-gray-300 h-44"></div>
            <h3 className="text-lg font-semibold text-gray-500 mt-2">texttexttexttext<span className="text-gray-700">samplesample</span></h3>
          </div>
          <div>
            <div className="bg-gray-300 h-44"></div>
            <h3 className="text-lg font-semibold text-gray-500 mt-2">texttexttexttext<span className="text-gray-700">samplesample</span></h3>
